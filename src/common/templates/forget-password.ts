const resetPassEmailTemp = (data:{name:string, verificationCode:string, verificationCodeExpire:number}) => `
  <html>
    <head>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <p>Thank you,<br>The OldCrisis Team</p>
      </div>
      <div class="footer">
        <p>&copy; ${new Date().getFullYear()} OldCrisis - All Rights Reserved.</p>
        <p>
          <a href="https://oldcrisis.com/privacy">Privacy Policy</a> |
          <a href="https://oldcrisis.com/contact">Contact Support</a>
        </p>
      </div>
    </body>
  </html>
